    ...
    <ScrollView style={styles.home}>
     <View style={styles.card}>
        <View style={styles.containerCardsColumn}>
          ...
          <LargeButton text="Cotações do momento!" bgColor="#fff623" navigate="Cotações" icon="trending-up-sharp"></LargeButton>
          <LargeButton text="Calcule qualquer tipo de juros!" bgColor="#45e1f8" navigate="Calculadora" icon="calculator-sharp"></LargeButton>
          <LargeButton text="Valores das Criptomoedas!" bgColor="#ff8f59" navigate="Cotações" icon="logo-bitcoin"></LargeButton>
